  ...
  studySidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: 'doc',
          id: 'funcoes/historia-dos-graficos',
          label: '5.3 História dos gráficos',
        },
        {
          type: 'doc',
          id: 'funcoes/dominio-e-imagem',
          label: '5.4 Domínio e imagem',
        },
        {
          type: 'doc',
          id: 'funcoes/crescimento-sinal-e-simetria',
          label: '5.5 Crescimento, sinal e simetria',
        },
        {
          type: 'doc',
          id: 'funcoes/funcao-afim',
          label: '5.6 Função afim',
        },
        {
          type: 'doc',
          id: 'funcoes/funcao-quadratica',
          label: '5.7 Função quadrática',
        },
        {
          type: 'doc',
          id: 'funcoes/transformacoes-de-graficos',
          label: '5.8 Transformações de gráficos',
        },
        {
          type: 'doc',
        ...
        },
        {
          ...
          label: '5.12 Funções potência e radicais',
        },
        {
          type: 'doc',
          id: 'funcoes/funcao-polinomial',
          label: '5.13 Função polinomial',
        },
        {
          type: 'doc',
          id: 'funcoes/divisao-de-polinomios',
          label: '5.14 Divisão de polinômios',
        },
        {
          type: 'doc',
          id: 'funcoes/raizes-racionais',
          label: '5.15 Raízes racionais',
        },
        {
          type: 'doc',
          id: 'funcoes/funcoes-racionais',
          label: '5.16 Funções racionais',
        },
        {
          type: 'doc',
          id: 'funcoes/taxa-media-de-variacao',
          label: '5.17 Taxa média de variação',
        },
      ],
    },
    {

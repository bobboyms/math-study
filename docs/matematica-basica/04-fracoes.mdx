...
<FractionBar
  bars={[
    {parts: 4, filled: 0, label: '\\text{pizza 1}'},
    {parts: 4, filled: 0, label: '\\text{pizza 2}'},
    {parts: 4, filled: 0, label: '\\text{pizza 3}'},
  ]}
  caption="Cada pizza cortada em 4 partes iguais: 12 pedaços do mesmo tamanho."
/>
...
<FractionBar
  bars={[
    {parts: 4, filled: 3, label: '\\text{pessoa A}', tone: 1},
    {parts: 4, filled: 3, label: '\\text{pessoa B}', tone: 1},
    {parts: 4, filled: 3, label: '\\text{pessoa C}', tone: 1},
    {parts: 4, filled: 3, label: '\\text{pessoa D}', tone: 1},
  ]}
  caption="Os 12 pedaços repartidos: 3 para cada pessoa, e nenhum sobra."
/>
...
<FractionBar
  bars={[{parts: 5, filled: 0}]}
  caption="A unidade dividida em 5 partes iguais — o denominador define o tamanho da parte."
/>

Se 3 partes ficam marcadas:

<FractionBar
  bars={[{parts: 5, filled: 3, label: '\\frac{3}{5}', tone: 1}]}
  caption="Três partes tomadas, de um total de cinco."
/>
...
<NumberLine
  ...
  labelEvery={5}
  unit={380}
  marks={[{at: 0.6, label: '\\frac{3}{5}', tone: 2}]}
  caption="O intervalo de 0 a 1 dividido em 5 passos iguais. Três passos levam a 3/5."
/>
...
<FractionBar
  bars={[{parts: 2, filled: 1, label: '\\frac{1}{2}', tone: 1}]}
  caption="Metade da barra."
/>
...
<FractionBar
  bars={[{parts: 4, filled: 2, label: '\\frac{2}{4}', tone: 1}]}
  caption="Cada metade repartida em duas: a região pintada é exatamente a mesma."
/>
...
<FractionBar
  ...
  caption="As 3 partes marcadas em 6 ocupam a mesma metade da barra. A divisão ficou mais fina; a quantidade marcada não mudou."
/>
...
<FractionBar
  bars={[
    {parts: 8, filled: 6, label: '\\frac{6}{8}', tone: 1},
    {parts: 4, filled: 3, label: '\\frac{3}{4}', tone: 2},
  ]}
  caption="Juntando os oitavos de 2 em 2, os mesmos 6 pedaços viram 3 grupos de um total de 4."
/>
...
<FractionBar
  bars={[
    {parts: 3, filled: 1, label: '\\frac{1}{3}', tone: 1},
    {parts: 5, filled: 1, label: '\\frac{1}{5}', tone: 2},
  ]}
  caption="Mesma unidade, mais cortes: quanto mais partes iguais, menor fica cada parte."
/>
...
<FractionBar
  bars={[
    {parts: 2, filled: 1, label: '\\frac{1}{2}', tone: 1},
    {parts: 3, filled: 1, label: '\\frac{1}{3}', tone: 2},
  ]}
  caption="Os cortes não coincidem: não há como somar metades com terços enquanto as partes tiverem tamanhos diferentes."
/>
...
<FractionBar
  bars={[
    {parts: 6, filled: 5, label: '\\frac{5}{6}', tone: 1},
    {parts: 5, filled: 2, label: '\\frac{2}{5}', tone: 2},
  ]}
  caption="Cinco sextos ocupam quase a unidade inteira; dois quintos ocupam menos da metade. As quantidades não são iguais."
/>
...
<AreaModel
  rows={[
    {size: 2, label: '\\frac{2}{3}'},
    {size: 1, label: '\\frac{1}{3}'},
  ]}
  cols={[
    {size: 4, label: '\\frac{4}{5}'},
    {size: 1, label: '\\frac{1}{5}'},
  ]}
  cells={[['\\frac{8}{15}', null], [null, null]]}
  unit={54}
  caption="Os cortes nos dois sentidos criam 15 partes pequenas. A região marcada nos dois sentidos ocupa 8 delas."
/>
...
<FractionBar
  bars={[
    {parts: 2, filled: 2, label: '\\text{1 metro}', tone: 1},
    {parts: 2, filled: 2, label: '\\text{1 metro}', tone: 1},
  ]}
  caption="Em cada metro cabem duas metades; nos 2 metros, quatro laços."
/>

...
<NumberLine
  ...
  max={5}
  unit={40}
  marks={[{at: 0, label: '0', tone: 3}]}
  caption="A mesma reta das operações básicas, agora continuando para a esquerda do zero."
/>
...
| Conta | Resultado | Leitura |
|---:|---:|---|
| $3 \times (-2)$ | $-6$ | tres dividas de 2: deve 6 |
| $2 \times (-2)$ | $-4$ | duas dividas de 2: deve 4 |
| $1 \times (-2)$ | $-2$ | uma divida de 2: deve 2 |
| $0 \times (-2)$ | $0$ | nenhuma divida: neutro |
...
| Conta | Resultado | Leitura |
|---:|---:|---|
| $-1 \times (-2)$ | $2$ | retirar uma divida de 2 melhora em 2 |
| $-2 \times (-2)$ | $4$ | retirar duas dividas melhora em 4 |
| $-3 \times (-2)$ | $6$ | retirar tres dividas melhora em 6 |
